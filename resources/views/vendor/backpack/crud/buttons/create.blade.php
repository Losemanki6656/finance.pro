@if ($crud->hasAccess('create'))
    <a href="{{ url($crud->route . '/create') }}" class="btn btn-primary" data-style="zoom-in"><span class="ladda-label"><i
...
@if ($crud->route == 'admin/consolidated')
    <a href="{{ backpack_url('vgo-import') }}" class="btn btn-xs btn-success"><i class="la la-file-excel"></i> Импорт </a>
...
@if ($crud->route == 'admin/consolidateoboroti')
    <a href="{{ backpack_url('oborot-import') }}" class="btn btn-xs btn-success"><i class="la la-file-excel"></i> Импорт Обороты</a>
