...
class DashboardController
{
    public function dashboard()
    {
        ...
        $users = Consolidated::where('ex_year', $year_balance)->select('send_inn')->groupBy('send_inn')->pluck('send_inn')->toArray();
        $oborots = ConsolidateOboroti::where('ex_year', $year_oboroti)->select('send_inn')->groupBy('send_inn')->pluck('send_inn')->toArray();
